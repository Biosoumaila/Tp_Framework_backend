    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col s12">
                ...
                <input type="text" name="id" style="display: none;" value="{{$books->id}}">
                  
                <div class="form-group">
                    <label for="Name">Title</label>
                      <input type="text" class="form-control" id="Title" name="name" value="{{$books->title}}">
                  </div>

                  <div class="form-group">
                    <label for="author_id">Author_id</label>
                      <input type="number" class="form-control" id="Author_id" name="author_id" value="{{$books->author_id}}" >
                  </div>
                  ...
                  <div class="form-group">
                    <label for="published_year">Published_year</label>
                      <input type="year" class="form-control" id="Published_year" name="published_year" value="{{$books->published_year}}" >
                  </div>
